...
func TestActionViewsView(t *testing.T) {
	...
	defer test.MockVariableValue(&setting.DefaultUILocation, parisTZ)()

	timeutil.MockSet(time.Date(2023, 5, 9, 13, 21, 32, 0, time.UTC))
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedJSON:      `{"state":{"run":{"preExecutionError":"","preExecutionWarnings":null,"link":"/user5/repo4/actions/runs/187","title":"update actions","titleHTML":"update actions","status":"success","canCancel":false,"canDelete":false,"canApprove":false,"canRerun":false,"canDeleteArtifact":false,"description":"Commit <a href=\"/user5/repo4/commit/c2d72f548424103f01ee1dc02889c1e2bff816b0\">c2d72f5484</a> pushed by <a href=\"/user1\">user1</a>","done":true,"estimatedOutcome":"success","jobs":[{"id":192,"name":"job_2","status":"success","canRerun":false,"duration":"_duration_"}],"commit":{"localeWorkflow":"Workflow","localeAllRuns":"all runs","shortSHA":"c2d72f5484","link":"/user5/repo4/commit/c2d72f548424103f01ee1dc02889c1e2bff816b0","pusher":{"displayName":"user1","link":"/user1"},"branch":{"name":"master","link":"/user5/repo4/src/branch/master","isDeleted":false}}},"currentJob":{"summaries":[],"title":"job_2","steps":[{"summary":"Set up job","duration":"_duration_","status":"running"},{"summary":"Complete job","duration":"_duration_","status":"waiting"}],"allAttempts":[{"number":3,"time_since_started_html":"_time_","status":"running","status_diagnostics":["Running for <relative-time datetime=\"2023-05-09T14:48:48+02:00\" format=\"duration\" prefix=\"\" data-tooltip-content data-tooltip-interactive=\"true\">32m44s</relative-time>"]},{"number":2,"time_since_started_html":"_time_","status":"success","status_diagnostics":["Succeeded <relative-time prefix=\"\" tense=\"past\" datetime=\"2023-05-09T14:50:26+02:00\" data-tooltip-content data-tooltip-interactive=\"true\">2023-05-09 14:50:26 +02:00</relative-time> in 1m38s"]},{"number":1,"time_since_started_html":"_time_","status":"success","status_diagnostics":["Succeeded <relative-time prefix=\"\" tense=\"past\" datetime=\"2023-05-09T14:50:26+02:00\" data-tooltip-content data-tooltip-interactive=\"true\">2023-05-09 14:50:26 +02:00</relative-time> in 1m38s"]}]}},"logs":{"stepsLog":[]}}`,
		...
		},
		{
			...
			expectedJSON:      `{"state":{"run":{"link":"/user5/repo4/actions/runs/209","title":"A scheduled workflow","titleHTML":"A scheduled workflow","status":"waiting","description":"Scheduled run of commit \u003ca href=\"/user5/repo4/commit/64357baca84bfff631e7dfae5a3433b26d005646\"\u003e64357baca8\u003c/a\u003e","canCancel":false,"canDelete":false,"canApprove":false,"canRerun":false,"canDeleteArtifact":false,"done":false,"estimatedOutcome":"unknown","jobs":[{"id":2153,"name":"job_2","status":"waiting","canRerun":false,"duration":"_duration_"}],"commit":{"localeWorkflow":"Workflow","localeAllRuns":"all runs","shortSHA":"64357baca8","link":"/user5/repo4/commit/64357baca84bfff631e7dfae5a3433b26d005646","pusher":{"displayName":"forgejo-actions","link":"/forgejo-actions"},"branch":{"name":"master","link":"/user5/repo4/src/branch/master","isDeleted":false}},"preExecutionError":"","preExecutionWarnings":null},"currentJob":{"summaries":[],"title":"job_2","steps":[{"summary":"Set up job","duration":"_duration_","status":"running"},{"summary":"Complete job","duration":"_duration_","status":"waiting"}],"allAttempts":[{"number":1,"time_since_started_html":"-","status":"waiting","status_diagnostics":["Waiting for <relative-time datetime=\"2023-05-09T14:47:08+02:00\" format=\"duration\" prefix=\"\" data-tooltip-content data-tooltip-interactive=\"true\">34m24s</relative-time> for a runner with the following labels: debian, gpu"]}]}},"logs":{"stepsLog":[]}}`,
		...
		},
		{
			...
			expectedJSON:      `{"state":{"run":{"link":"/user5/repo4/actions/runs/210","title":"A triggered run","titleHTML":"A triggered run","status":"waiting","description":"Run of commit \u003ca href=\"/user5/repo4/commit/f4100ac14112a3740490afb22b07b69b0b5d4e8b\"\u003ef4100ac141\u003c/a\u003e triggered by \u003ca href=\"/user29\"\u003euser29\u003c/a\u003e","canCancel":false,"canDelete":false,"canApprove":false,"canRerun":false,"canDeleteArtifact":false,"done":false,"estimatedOutcome":"unknown","jobs":[{"id":2154,"name":"mirror","status":"waiting","canRerun":false,"duration":"_duration_"}],"commit":{"localeWorkflow":"Workflow","localeAllRuns":"all runs","shortSHA":"f4100ac141","link":"/user5/repo4/commit/f4100ac14112a3740490afb22b07b69b0b5d4e8b","pusher":{"displayName":"user29","link":"/user29"},"branch":{"name":"master","link":"/user5/repo4/src/branch/master","isDeleted":false}},"preExecutionError":"","preExecutionWarnings":null},"currentJob":{"summaries":[],"title":"mirror","steps":[{"summary":"Set up job","duration":"_duration_","status":"running"},{"summary":"Complete job","duration":"_duration_","status":"waiting"}],"allAttempts":[{"number":1,"time_since_started_html":"-","status":"waiting","status_diagnostics":["Waiting for - for a runner with the following label: windows"]}]}},"logs":{"stepsLog":[]}}`,
			expectedArtifacts: "{\"artifacts\":[]}\n",
		},
		{
			...
			expectedJSON:      `{"state":{"run":{"link":"/user5/repo4/actions/runs/211","title":"A pull_request_target run","titleHTML":"A pull_request_target run","status":"waiting","description":"Commit \u003ca href=\"/user5/repo4/commit/f4100ac14112a3740490afb22b07b69b0b5d4e8b\"\u003ef4100ac141\u003c/a\u003e pushed by \u003ca href=\"/user29\"\u003euser29\u003c/a\u003e","canCancel":false,"canApprove":false,"canRerun":false,"canDeleteArtifact":false,"canDelete":false,"done":false,"estimatedOutcome":"unknown","jobs":[{"id":2155,"name":"target_job","status":"waiting","canRerun":false,"duration":"_duration_"}],"commit":{"localeWorkflow":"Workflow","localeAllRuns":"all runs","shortSHA":"f4100ac141","link":"/user5/repo4/commit/f4100ac14112a3740490afb22b07b69b0b5d4e8b","pusher":{"displayName":"user29","link":"/user29"},"branch":{"name":"master","link":"/user5/repo4/src/branch/master","isDeleted":false}},"preExecutionError":"","preExecutionWarnings":null},"currentJob":{"summaries":[],"title":"target_job","steps":[{"summary":"Set up job","duration":"_duration_","status":"running"},{"summary":"Complete job","duration":"_duration_","status":"waiting"}],"allAttempts":[{"number":1,"time_since_started_html":"-","status":"waiting","status_diagnostics":["Waiting for - for a runner with the following label: macos"]}]}},"logs":{"stepsLog":[]}}`,
			expectedArtifacts: "{\"artifacts\":[]}\n",
		},
	}
...
func TestActionViewsViewAttemptOutOfRange(t *testing.T) {
	...
	htmlDoc.AssertAttrPredicate(t, selector, "data-initial-post-response", func(actual string) {
		...
		expected := `{"state":{"run":{"preExecutionError":"","preExecutionWarnings":null,"link":"/user5/repo4/actions/runs/190","title":"job output","titleHTML":"job output","status":"waiting","canCancel":false,"canDelete":false,"canApprove":false,"canRerun":false,"canDeleteArtifact":false,"description":"Commit <a href=\"/user5/repo4/commit/c2d72f548424103f01ee1dc02889c1e2bff816b0\">c2d72f5484</a> pushed by <a href=\"/user1\">user1</a>","done":false,"estimatedOutcome":"unknown","jobs":[{"id":396,"name":"job_2","status":"waiting","canRerun":false,"duration":"_duration_"}],"commit":{"localeWorkflow":"Workflow","localeAllRuns":"all runs","shortSHA":"c2d72f5484","link":"/user5/repo4/commit/c2d72f548424103f01ee1dc02889c1e2bff816b0","pusher":{"displayName":"user1","link":"/user1"},"branch":{"name":"test","link":"/user5/repo4/src/branch/test","isDeleted":true}}},"currentJob":{"summaries":[],"title":"job_2","steps":[],"allAttempts":[{"number":1,"status":"waiting","status_diagnostics":["Waiting for - for a runner with the following label: fedora"],"time_since_started_html":"not started"}]}},"logs":{"stepsLog":[]}}`
		assert.JSONEq(t, expected, actualClean)
	})
